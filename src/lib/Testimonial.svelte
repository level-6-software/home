<script>
  const austin = '/austin-testimony.webp';
</script>
<div class="bg-white py-12">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
        <img class="absolute inset-0 h-full w-full object-cover object-top brightness-150 saturate-0" src={austin} alt="">
        ...
        <div class="relative mx-auto max-w-2xl lg:mx-0">
          <figure>
            ...
            <figcaption class="mt-6 text-base text-white">
              <div class="font-semibold">Austin Stanley</div>
              <div class="mt-1">Creator of PrintHole</div>
            </figcaption>
          </figure>
        </div>
      </div>
