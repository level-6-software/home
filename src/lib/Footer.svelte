...
<footer class="bg-white relative border-t border-gray-900/10 mt-12" aria-labelledby="footer-heading">
    <h2 id="footer-heading" class="sr-only">Footer</h2>
    <div class="mx-auto max-w-7xl px-6 py-16 sm:py-12 lg:px-8 lg:py-12">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <img class="h-7" src={logo} alt="Company name">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul role="list" class="mt-6 space-y-4">
                <li>
                  <a href="/about/#analytics" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Analytics</a>
                </li>
  
                <li>
                  <a href="/ecommerce" class="text-sm leading-6 text-gray-600 hover:text-gray-900">E-Commerce</a>
                </li>
              </ul>
            </div>
            <div class="mt-10 md:mt-0">
              ...
              <ul role="list" class="mt-6 space-y-4">
                ...
                <li>
                  <a href="/guide" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Guides</a>
                </li>
              </ul>
            </div>
          </div>
